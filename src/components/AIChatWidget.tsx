                    ...
                    <div className={`max-w-[78%] flex flex-col gap-2`}>
                      ...
                      {msg.showCTA && (
                        <div className="flex flex-col gap-2">
                          ...
                          <motion.a
                            href="https://wa.me/917200696059?text=Hi%20AutoScriptPro,%20I%20just%20chatted%20with%20Aria%20and%20I'm%20interested%20in%20learning%20more!"
                            target="_blank"
                            rel="noopener noreferrer"
                            initial={{ opacity: 0, y: 8 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.5 }}
                            className="flex items-center justify-center gap-2 w-full py-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white text-xs font-bold rounded-2xl transition-colors shadow-sm cursor-none"
                          >
